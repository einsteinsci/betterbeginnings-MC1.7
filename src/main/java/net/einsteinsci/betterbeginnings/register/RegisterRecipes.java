...
public class RegisterRecipes
{
	...
	private static void addBrickOvenRecipes()
	{
		...
		BrickOvenRecipeHandler.addShapedRecipe(new ItemStack(Items.cake), "MMM", "SES", "WWW",
			...
			'E', Items.egg,
			'W', Items.wheat);
		BrickOvenRecipeHandler.addShapedRecipe(new ItemStack(Items.bread, 2), "WWW",
			'W', Items.wheat);
		...
		BrickOvenRecipeHandler.addShapelessRecipe(new ItemStack(Items.cooked_fished, 1, 1),
		...
		BrickOvenRecipeHandler.addShapelessRecipe(new ItemStack(Items.magma_cream), Items.slime_ball,
			Items.blaze_powder);
	...
	public static void addAdvancedRecipes()
	{
		...
		if (BBConfig.moduleInfusionRepair)
		{
			...
			AdvancedCraftingHandler.addAdvancedRecipe(new ItemStack(RegisterBlocks.infusionRepairStation),
				new Object[]{ "dustRedstone", 32, "dyeBlue", 32, new ItemStack(Items.blaze_powder, 16) },
				"DID", "OSO", "OOO",
				'D', "gemDiamond",
				'I', "blockIron",
				'S', Blocks.bookshelf,
